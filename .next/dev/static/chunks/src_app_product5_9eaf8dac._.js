...
const productFormSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    productName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, "Vui lòng nhập tên sản phẩm.").max(200, "Tên sản phẩm không quá 200 ký tự."),
    productDescription: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(5000, "Mô tả không quá 5000 ký tự").optional().default("")
});
...
;
;
function useCategoryTree(initialSelectedCategoryId) {
    _s();
    ...
    // Khi đã có cây và có selected category (vd. từ product edit), đổ path + leaf ra
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCategoryTree.useEffect": ()=>{
            const id = initialSelectedCategoryId != null && Number.isFinite(initialSelectedCategoryId) ? Number(initialSelectedCategoryId) : null;
            if (!loadingCategories && categories.length > 0 && id != null) {
                const found = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$product5$2f$utils$2f$findCategoryPathById$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findCategoryPathById"])(categories, id);
                if (found) {
                    setCategoryPath(found.path);
                    setSelectedLeaf(found.node);
                }
            }
        }
    }["useCategoryTree.useEffect"], [
...
_s(useCategoryTree, "YIK+tA48ZmMFl+gSj/9NFEtH1I8=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/src/app/product5/utils/mockCategoryTree.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function mapProductToFormData(product) {
    ...
    // map selectedAttributes -> attributeSelections
    ...
    // map tiers -> classifications (name + option names)
    const classifications = product.tiers?.map((tier)=>({
            id: String(tier.id),
            name: tier.name,
            options: tier.options.map((opt)=>opt.name)
        })) ?? [];
    // build lookups for variations
    const tierOrderById = new Map(); // tierId -> index
    const optionNameByTierAndOptionId = new Map(); // `${tierId}:${optionId}` -> name
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$product5$2f$utils$2f$generateCartesianProduct$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/product5/utils/generateCartesianProduct.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$product5$2f$utils$2f$validateSalesInfo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/product5/utils/validateSalesInfo.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$product5$2f$utils$2f$mockCategoryTree$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/product5/utils/mockCategoryTree.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$product5$2f$utils$2f$prepareFormData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/product5/utils/prepareFormData.ts [app-client] (ecmascript)");
...
//# sourceMappingURL=src_app_product5_9eaf8dac._.js.map