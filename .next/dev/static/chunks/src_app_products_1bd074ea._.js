...
"[project]/src/app/products/utils/mockCategoryTree.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$utils$2f$mockCategoryTree$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/products/utils/mockCategoryTree.ts [app-client] (ecmascript)");
            ...
            const loadCategoryTree = {
                "useCategoryTree.useEffect.loadCategoryTree": async ()=>{
                    try {
                        ...
                        const mocks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$utils$2f$mockCategoryTree$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMockCategoryRoots"])();
                        setCategories([
                            ...serverCategories,
                            ...mocks
                        ]);
...
"[project]/src/app/products/utils/prepareFormData.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/products/utils/mapProductToFormData.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/products/utils/index.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$utils$2f$validateSalesInfo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/products/utils/validateSalesInfo.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$utils$2f$mockCategoryTree$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/products/utils/mockCategoryTree.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$utils$2f$prepareFormData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/products/utils/prepareFormData.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$utils$2f$mapProductToFormData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/products/utils/mapProductToFormData.ts [app-client] (ecmascript)");
;
;
;
;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$utils$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/app/products/utils/index.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$utils$2f$prepareFormData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/products/utils/prepareFormData.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$utils$2f$mapProductToFormData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/products/utils/mapProductToFormData.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
...
function EditProductPage() {
            ...
            const loadProduct = {
                "EditProductPage.useEffect.loadProduct": async ()=>{
                    try {
                        ...
                        const data = res.data;
                        const mapped = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$utils$2f$mapProductToFormData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mapProductToFormData"])(data);
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const formData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$utils$2f$prepareFormData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["prepareFormData"])({
                shopId,
                productName,
                productDescription,
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/api/product/${productId}/update`, formData);
            alert("Cập nhật sản phẩm thành công!");
            salesInfo.resetAfterSubmit();
            attributes.setAttributeSelections({});
            imageUpload.clearProductImages();
        } catch (err) {
            const msg = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].isAxiosError(err) && err.response?.data ? String(err.response.data) : err instanceof Error ? err.message : "Không thể cập nhật sản phẩm. Vui lòng thử lại.";
            setSubmitError(msg);
        } finally{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: loadingProduct ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "text-sm text-[var(--muted-foreground)]",
...
_s(EditProductPage, "aB+AJFen+nR4JNBT6DEyrs2G2gM=", false, function() {
    return [
...
//# sourceMappingURL=src_app_products_1bd074ea._.js.map